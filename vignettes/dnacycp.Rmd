...
ex1_smooth <- dnacycp::cycle_fasta(ex1_file,smooth=TRUE,n_cores=1,chunk_length=1000)
ex1_original <- dnacycp::cycle_fasta(ex1_file,smooth=FALSE,n_cores=1,chunk_length=1000)
```
...
`chunk_length=1000` specifies that predictions will be made on sequences of length 1000 at a given time
