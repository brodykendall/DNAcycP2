...
* `smooth=TRUE`: DNAcycP2 (the model trained on smoothed, unbiased data -- recommended) 
...
ex1_smooth <- dnacycp2::cycle_fasta(ex1_file,smooth=TRUE,n_cores=1,chunk_length=1000)
ex1_original <- dnacycp2::cycle_fasta(ex1_file,smooth=FALSE,n_cores=1,chunk_length=1000)
```
